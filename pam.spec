...
Patch11: pam-1.1.1-faillock.patch
Patch12: pam-1.1.1-limits-range.patch
Patch13: pam-1.1.1-review.patch
Patch14: pam-1.1.1-audit-data.patch
Patch15: pam-1.1.1-full-relro.patch
Patch16: pam-1.1.1-cracklib-checks.patch
Patch17: pam-1.1.1-limits-docfix.patch
Patch18: pam-1.1.1-lastlog-inactive.patch
Patch19: pam-1.1.1-namespace-fixes.patch
Patch20: pam-1.1.1-authtok-type.patch
Patch21: pam-1.1.1-unix-remember.patch
...
%patch16 -p1 -b .checks
%patch17 -p1 -b .docfix
%patch18 -p1 -b .inactive
%patch19 -p1 -b .nsfixes
%patch20 -p1 -b .authtok-type
%patch21 -p1 -b .remember
...
make LDFLAGS="-Wl,--as-needed -Wl,-O1 -Wl,-z,relro"
...
* Wed Sep 25 2013 Tomas Mraz <tmraz@redhat.com> 1.1.1-15
- add option to pam_tty_audit to disable auditing of password
  input

* Mon Oct 15 2012 Tomas Mraz <tmraz@redhat.com> 1.1.1-13
- fix environment file handling problems - CVE-2011-3148 (#746619) and
  CVE-2011-3148 (#746620)

* Fri Oct 12 2012 Tomas Mraz <tmraz@redhat.com> 1.1.1-12
...
* Mon Apr  2 2012 Tomas Mraz <tmraz@redhat.com> 1.1.1-11
- additional password checks in pam_cracklib

* Mon Aug 15 2011 Tomas Mraz <tmraz@redhat.com> 1.1.1-10
- add relro to LDFLAGS and link setuid binaries
  with full relro (#727286)

* Thu Feb 24 2011 Tomas Mraz <tmraz@redhat.com> 1.1.1-8
- fix wrong auditing in pam_selinux and more small memory
  leaks in this module

* Tue Feb 22 2011 Tomas Mraz <tmraz@redhat.com> 1.1.1-7
- fix a few memory leaks in error paths and other mistakes
  found by a code review
- add rhost and tty to auditing data in modules (#677664)

* Tue Jan 25 2011 Tomas Mraz <tmraz@redhat.com> 1.1.1-6
- do not overwrite /var/log/tallylog on package update (#614766)
- add support for uid and gid ranges in limits.conf (#622847)
- add new pam_faillock module (#644971)

* Wed Oct 20 2010 Tomas Mraz <tmraz@redhat.com> 1.1.1-5
